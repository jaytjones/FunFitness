...
struct Milestone: Identifiable {
    ...
    func getTitle(for theme: Theme) -> String {
        title[theme] ?? "Milestone Reached!"
    }
...
struct ComparisonEngine {
    ...
    static let distanceMilestones: [Milestone] = [
        Milestone(
            ...
            title: [
                .animals: "You've run 1 mile!",
                .cities: "You've run 1 mile!",
                .landmarks: "You've run 1 mile!"
            ],
            comparisonText: [
        ...
        Milestone(
            ...
            emoji: [.animals: "🐳", .cities: "🌳", .landmarks: "🌉"],
            title: [
                .animals: "You've run 5 miles!",
                .cities: "You've run 5 miles!",
                .landmarks: "You've run 5 miles!"
            ],
            comparisonText: [
        ...
        Milestone(
            ...
            emoji: [.animals: "🏃", .cities: "🏙", .landmarks: "🎰"],
            title: [
                .animals: "Half Marathon Complete!",
                .cities: "Half Marathon Complete!",
                .landmarks: "Half Marathon Complete!"
            ],
            comparisonText: [
        ...
        Milestone(
            ...
            emoji: [.animals: "🏅", .cities: "🤖", .landmarks: "🇨🇳"],
            title: [
                .animals: "Full Marathon Complete!",
                .cities: "Full Marathon Complete!",
                .landmarks: "Full Marathon Complete!"
            ],
            comparisonText: [
        ...
        Milestone(
            ...
            emoji: [.animals: "🐃", .cities: "🚗", .landmarks: "🧗"],
            title: [
                .animals: "You've run 50 miles!",
                .cities: "You've run 50 miles!",
                .landmarks: "You've run 50 miles!"
            ],
            comparisonText: [
        ...
        Milestone(
            ...
            emoji: [.animals: "🦋", .cities: "🏙", .landmarks: "🌊"],
            title: [
                .animals: "You've run 100 miles!",
                .cities: "You've run 100 miles!",
                .landmarks: "You've run 100 miles!"
            ],
            comparisonText: [
    ...
    static let weightMilestones: [Milestone] = [
        Milestone(
            ...
            emoji: [.animals: "🦁", .cities: "🚗", .landmarks: "🔔"],
            title: [
                .animals: "You've lifted 500 lbs!",
                .cities: "You've lifted 500 lbs!",
                .landmarks: "You've lifted 500 lbs!"
            ],
            comparisonText: [
        ...
        Milestone(
            ...
            emoji: [.animals: "🦛", .cities: "🚗", .landmarks: "🗽"],
            title: [
                .animals: "You've lifted 2,500 lbs!",
                .cities: "You've lifted 2,500 lbs!",
                .landmarks: "You've lifted 2,500 lbs!"
            ],
            comparisonText: [
        ...
        Milestone(
            ...
            emoji: [.animals: "🐘", .cities: "🚌", .landmarks: "🔔"],
            title: [
                .animals: "You've lifted 10,000 lbs!",
                .cities: "You've lifted 10,000 lbs!",
                .landmarks: "You've lifted 10,000 lbs!"
            ],
            comparisonText: [
        ...
        Milestone(
            ...
            emoji: [.animals: "🦴", .cities: "🚒", .landmarks: "🧱"],
            title: [
                .animals: "You've lifted 25,000 lbs!",
                .cities: "You've lifted 25,000 lbs!",
                .landmarks: "You've lifted 25,000 lbs!"
            ],
            comparisonText: [
        ...
        Milestone(
            ...
            emoji: [.animals: "🐳", .cities: "🚚", .landmarks: "🗿"],
            title: [
                .animals: "You've lifted 50,000 lbs!",
                .cities: "You've lifted 50,000 lbs!",
                .landmarks: "You've lifted 50,000 lbs!"
            ],
            comparisonText: [
        ...
        Milestone(
            ...
            emoji: [.animals: "💙", .cities: "🚀", .landmarks: "🛕"],
            title: [
                .animals: "You've lifted 100,000 lbs!",
                .cities: "You've lifted 100,000 lbs!",
                .landmarks: "You've lifted 100,000 lbs!"
            ],
            comparisonText: [
    ...
    static var allMilestones: [Milestone] {
        distanceMilestones + weightMilestones
    }
