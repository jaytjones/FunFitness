...
struct Milestone: Identifiable {
    ...
    func getEmoji(for theme: Theme) -> String       { emoji[theme] ?? "🎯" }
    func getComparison(for theme: Theme) -> String  { comparisonText[theme] ?? "Great work!" }
    func getTicker(for theme: Theme) -> String      { ticker[theme] ?? "your next goal" }
}
...
struct ComparisonEngine {
    ...
    static let distanceMilestones: [Milestone] = [
        Milestone(
            id: "D1", threshold: 1.60934, unit: .kilometers,
            ...
            ticker: [.animals: "a giraffe parade", .cities: "18 NYC blocks", .landmarks: "4 Eiffel Towers"]
        ),
        Milestone(
            id: "D1b", threshold: 4.02336, unit: .kilometers,
            ...
            ticker: [.animals: "a cat parade", .cities: "half of Central Park", .landmarks: "25 Statues of Liberty"]
        ),
        Milestone(
            id: "D2", threshold: 8.04672, unit: .kilometers,
            ...
            ticker: [.animals: "2 blue whales", .cities: "Central Park", .landmarks: "the Golden Gate Bridge"]
        ),
        Milestone(
            id: "D2b", threshold: 16.0934, unit: .kilometers,
            ...
            ticker: [.animals: "an eagle's patrol route", .cities: "the Manhattan-to-JFK trip", .landmarks: "2.5 Grand Canyon crossings"]
        ),
        Milestone(
            id: "D3", threshold: 21.0975, unit: .kilometers,
            ...
            ticker: [.animals: "a half marathon", .cities: "Manhattan island", .landmarks: "5 Vegas Strips"]
        ),
        Milestone(
            id: "D3b", threshold: 28.1635, unit: .kilometers,
            ...
            ticker: [.animals: "a mountain lion's daily hunt", .cities: "LA-to-Santa Monica laps", .landmarks: "45 Champs-Élysées strolls"]
        ),
        Milestone(
            id: "D4", threshold: 42.195, unit: .kilometers,
            ...
            ticker: [.animals: "a full marathon", .cities: "Austin to Round Rock", .landmarks: "the Great Wall section"]
        ),
        Milestone(
            id: "D4b", threshold: 56.3270, unit: .kilometers,
            ...
            ticker: [.animals: "a wolf's nightly hunt", .cities: "the Philly-to-NYC trip", .landmarks: "10 Hudson River Greenways"]
        ),
        Milestone(
            id: "D5", threshold: 80.4672, unit: .kilometers,
            ...
            ticker: [.animals: "a wildebeest migration", .cities: "Austin to San Antonio", .landmarks: "an Appalachian Trail day"]
        ),
        Milestone(
            id: "D5b", threshold: 120.701, unit: .kilometers,
            ...
            ticker: [.animals: "a dolphin's daily swim", .cities: "the NYC-to-Philly trip", .landmarks: "3 English Channel crossings"]
        ),
        Milestone(
            id: "D6", threshold: 160.934, unit: .kilometers,
            ...
            ticker: [.animals: "a Monarch butterfly's day", .cities: "Austin to Houston", .landmarks: "4 English Channels"]
        ),
    ]
    ...
    static let weightMilestones: [Milestone] = [
        Milestone(
            id: "W1", threshold: 226.796, unit: .kilograms,
            ...
            ticker: [.animals: "a male lion", .cities: "a Smart Car", .landmarks: "a church bell"]
        ),
        Milestone(
            id: "W1b", threshold: 453.592, unit: .kilograms,
            ...
            ticker: [.animals: "a grizzly bear", .cities: "a Honda Civic", .landmarks: "2 Liberty Bells"]
        ),
        Milestone(
            id: "W2", threshold: 1133.98, unit: .kilograms,
            ...
            ticker: [.animals: "a hippo", .cities: "a Mini Cooper", .landmarks: "Liberty's torch"]
        ),
        Milestone(
            id: "W2b", threshold: 2267.96, unit: .kilograms,
            ...
            ticker: [.animals: "a white rhinoceros", .cities: "a loaded F-150", .landmarks: "a school bus engine"]
        ),
        Milestone(
            id: "W3", threshold: 4535.92, unit: .kilograms,
            ...
            ticker: [.animals: "an elephant", .cities: "a transit bus", .landmarks: "a Liberty Bell replica"]
        ),
        Milestone(
            id: "W3b", threshold: 6803.89, unit: .kilograms,
            ...
            ticker: [.animals: "3 giraffes", .cities: "an empty city bus", .landmarks: "a Stonehenge trilithon"]
        ),
        Milestone(
            id: "W4", threshold: 11339.8, unit: .kilograms,
            ...
            ticker: [.animals: "a T-Rex skull", .cities: "a fire truck", .landmarks: "a Berlin Wall section"]
        ),
        Milestone(
            id: "W4b", threshold: 15875.7, unit: .kilograms,
            ...
            ticker: [.animals: "a college-age humpback", .cities: "a loaded school bus", .landmarks: "525 Wright Flyers"]
        ),
        Milestone(
            id: "W5", threshold: 22679.6, unit: .kilograms,
            ...
            ticker: [.animals: "a humpback whale", .cities: "a loaded semi-truck", .landmarks: "a Stonehenge section"]
        ),
        Milestone(
            id: "W5b", threshold: 34019.4, unit: .kilograms,
            ...
            ticker: [.animals: "a sperm whale", .cities: "an 18-wheeler", .landmarks: "3 rocket booster casings"]
        ),
        Milestone(
            id: "W6", threshold: 45359.2, unit: .kilograms,
            ...
            ticker: [.animals: "a blue whale's heart", .cities: "a shuttle main engine", .landmarks: "a pyramid capstone"]
        ),
    ]
